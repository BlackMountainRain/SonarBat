...
func (c *authClient) SignInWithOAuth(ctx context.Context, in *SignInWithOAuthRequest, opts ...grpc.CallOption) (*AuthReply, error) {
	out := new(AuthReply)
	err := c.cc.Invoke(ctx, Auth_SignInWithOAuth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) GetSupportedOAuthProviders(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*SupportedOAuthProvidersReply, error) {
	...
	err := c.cc.Invoke(ctx, Auth_GetSupportedOAuthProviders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ValidateJWT(ctx context.Context, in *ValidateJWTRequest, opts ...grpc.CallOption) (*UserInfoReply, error) {
	...
	err := c.cc.Invoke(ctx, Auth_ValidateJWT_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) VerifyPasswordResetToken(ctx context.Context, in *VerifyPasswordResetTokenRequest, opts ...grpc.CallOption) (*VerifyPasswordResetTokenReply, error) {
	...
	err := c.cc.Invoke(ctx, Auth_VerifyPasswordResetToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

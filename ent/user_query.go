...
func (uq *UserQuery) QueryRoles() *RbacRoleQuery {
	query := (&RbacRoleClient{config: uq.config}).Query()
...
func (uq *UserQuery) WithRoles(opts ...func(*RbacRoleQuery)) *UserQuery {
	query := (&RbacRoleClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withRoles; query != nil {
		if err := uq.loadRoles(ctx, query, nodes,
			func(n *User) { n.Edges.Roles = []*RbacRole{} },
			func(n *User, e *RbacRole) { n.Edges.Roles = append(n.Edges.Roles, e) }); err != nil {
			return nil, err
		}
	}
...
func (uq *UserQuery) loadRoles(ctx context.Context, query *RbacRoleQuery, nodes []*User, init func(*User), assign func(*User, *RbacRole)) error {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(rbacrole.FieldID), joinT.C(user.RolesPrimaryKey[0]))
	...
	neighbors, err := withInterceptors[[]*RbacRole](ctx, query, qr, query.inters)
	if err != nil {
		return err
	}
